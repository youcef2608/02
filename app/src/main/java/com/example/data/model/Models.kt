...
data class UserProfile(
    ...
    val role: String = "VOLUNTEER", // "VOLUNTEER" or "ASSOCIATION"
    val roleTitle: String = "متطوع ميداني نشط",
    val associationName: String = "",
    val badgeNumber: String = "VOL-2026-018",
    val phone: String = "0550 12 34 56",
    val wilaya: String = "16 - الجزائر العاصمة",
    val isVerified: Boolean = true,
    val city: String = "الجزائر العاصمة",
    val governorate: String = "ولاية الجزائر",
